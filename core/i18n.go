...
// SetLang 重写语言 (disabling auto-detect).
...
// 根据传入的msgkey类型(开始,处理完成,失败等), 返回对应语言的预置文本
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgHelpTitle: {
		LangEnglish:            "tc-connect Help",
		LangChinese:            "tc-connect 帮助",
		LangTraditionalChinese: "tc-connect 說明",
		LangJapanese:           "tc-connect ヘルプ",
	},
