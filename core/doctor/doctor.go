...
// 执行所有诊断检查
func RunDoctorChecks(ctx context.Context, agent types.Agent, platform types.Platform) []DoctorCheckResult {
...
// 直接添加为connected
func checkPlatform(platform types.Platform) []DoctorCheckResult {
...
// 将检查结果中的文本统一为i18n的语言
func localizeCheckName(name string, lang i18n.Language) string {
	switch lang {
...
// 系统语言格式化检查结果
func FormatDoctorResults(results []DoctorCheckResult, curI18n *i18n.I18n) string {
	lang := curI18n.CurrentLang()

	var sb strings.Builder
	sb.WriteString(curI18n.T(i18n.MsgDoctorTitle))
	...
	sb.WriteString(curI18n.Tf(i18n.MsgDoctorSummary, passCount, warnCount, failCount))
	return sb.String()
}
